package com.github.rapid.security.gate.filter;
...
import com.github.rapid.security.common.msg.auth.TokenErrorResponse;
import com.github.rapid.security.common.util.ClientUtil;
import com.github.rapid.security.gate.rpc.ILogService;
import com.github.rapid.security.gate.rpc.IUserService;
import com.github.rapid.security.gate.jwt.JwtTokenUtil;
...
public class SessionAccessFilter extends ZuulFilter {
    private static final Logger log = Logger.getLogger(SessionAccessFilter.class);
